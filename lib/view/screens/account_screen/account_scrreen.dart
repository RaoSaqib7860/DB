      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Center(
                      child: Icon(Icons.image,color: blueColor,size: 10.w,),
                    ),
                  ),
                  SizedBox(width: 3.w,),
                  Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => StoreSettingScreen(),));
                        },
                        child: Text(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            padding: EdgeInsets.symmetric(horizontal: 7.w,vertical: 1.1.h),
                            child: Text(
            ...
            GestureDetector(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => AnalyticScreen(),));
                },
