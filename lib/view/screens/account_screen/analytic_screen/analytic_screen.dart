...
class _AnalyticScreenState extends State<AnalyticScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return DataLoading(
      isLoading: loading,
      child: Scaffold(
        body: provider.getOrserHistoryModel == null ||
                (provider.getOrserHistoryModel == null &&
                    provider.getAnalyticsModel == null)
            ? SizedBox()
            : loading == true
                ? SizedBox()
                          ...
                          children: [
                                ...
                                children: [
                                  ...
                                  Expanded(
                                      child: customContainer(
                                          ...
                                          subTitle:
                                              '${provider.getOrserHistoryModel!.data!.canceled}',
                                ...
                                children: [
                                  Expanded(
                                      child: customContainer(
                                          ...
                                          subTitle:
                                              '${provider.getOrserHistoryModel!.data!.proccess}',
                            ...
                            Padding(
                              ...
                              child: customContainer(
                                  ...
                                  subTitle:
                                      '${provider.getOrserHistoryModel!.data!.amounts}',
                                  color: Color(0xff1568A8)),
                            ),
                            SizedBox(
                              height: 1.5.h,
                            ...
                            Padding(
                              ...
                              child: customContainer(
                                  ...
                                  subTitle:
                                      '${provider.getOrserHistoryModel!.data!.amountProccess}',
                            ...
                            Padding(
                              ...
                              child: customContainer(
                                  ...
                                  subTitle:
                                      '${provider.getOrserHistoryModel!.data!.amountCompleted}',
                                  color: Color(0xff0CA011),
                                  imageSize: 1.7.h),
                            ),
                            SizedBox(
                            ...
                            Container(
                                ...
                                child: ListView.builder(
                                  itemCount: provider.getOrserHistoryModel?.data
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Expanded(
                                      child: ListView.builder(
                                        itemCount: provider.getAnalyticsModel
                                                ?.data?.pages?.length ??
                                            0,
                                        itemBuilder: (context, index) {
                                          return Padding(
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    Container(
                                                      width: 60.w,
                                                      child: Text(
                                                        '${provider.getAnalyticsModel!.data!.pages![index].url}',
                                                        maxLines: 1,
                                                    ...
                                                    Text(
                                                        '${provider.getAnalyticsModel!.data!.pages![index].viewCount}'),
                                                  ],
                                                ),
                                                Divider(),
                                              ],
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      child: Text(
                                                        '${index + 1}'
                                                        ': ${provider.getAnalyticsModel!.data!.cities![index].city} '
                                                        '- Visits ${provider.getAnalyticsModel!.data!.cities![index].viewCount}',
                                                        maxLines: 1,
                                                        overflow: TextOverflow
                                                            .ellipsis,
                                                      ),
            ...
            Container(
              ...
              child: Center(
                child: SvgPicture.asset(
                  ...
                  height: imageSize != null ? imageSize : 2.5.h,
                ),
              ),
            ),
            SizedBox(
