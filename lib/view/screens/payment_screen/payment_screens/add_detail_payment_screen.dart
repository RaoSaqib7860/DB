...
class AddDetailPaymentScreen extends StatefulWidget {
  const AddDetailPaymentScreen({Key? key}) : super(key: key);

  @override
  State<AddDetailPaymentScreen> createState() => _AddDetailPaymentScreenState();
}

class _AddDetailPaymentScreenState extends State<AddDetailPaymentScreen> {
  bool _value = false;
  @override
