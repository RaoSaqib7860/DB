...
class InventoryScreen extends StatefulWidget {
  ...
  const InventoryScreen({this.index,Key? key,this.productId}) : super(key: key);
...
class _InventoryScreenState extends State<InventoryScreen> {
  ...
  api_call()async{
    ...
    skuController.text = provider.updateInventoryProduct?.data?.info?.stock?.sku ?? '';
    ...
    return DataLoading(
      ...
      child: Scaffold(
        body: SingleChildScrollView(
          child:provider.updateInventoryProduct == null? SizedBox(): Container(
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: CustomLineTextField(name: 'SKU',hint: '#ABC-123',controller: skuController),
                ),
                Padding(
                  padding:  EdgeInsets.symmetric(horizontal: 6.w),
                  child: Text(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                            //width: 50.w,
                            height: 10.h,
                            child: ListView.builder(itemCount: provider.updateInventoryProduct!.data!.stockData!.length,itemBuilder: (context, index) {
                          return Padding(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: Center(
                                            child: Image.network(fit: BoxFit.cover,'https:${provider.updateInventoryProduct!.data!.stockData![index].colorImage}'),
                                          ),
                                        ),
                                      ),
                                      Text(
