...
class _TotalInventoryScreenState extends State<TotalInventoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: DataLoading(
        isLoading: provider.inventory_loading,
        child: Column(
          ...
          children: [
            ...
            Expanded(
                child: ListView.builder(
                  itemCount: provider.getInvontoryModel?.data?.length ?? 0,
                                      ...
                                      Container(
                                        ...
                                        child: Center(
                                          child: CachedNetworkImage(
                                            imageUrl:
                                            "https://${user_model.data?.domain}/${provider.getInvontoryModel!.data![index].term!.preview!.media!.url}",
                                            fit: BoxFit.contain,
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    RichText(
                                                        text: TextSpan(
                                                            children: [
                                                              ...
                                                              TextSpan(
                                                                  text: '${provider.getInvontoryModel!.data![index].sku} ',
                                                                  style: TextStyle(
                                                    ...
                                                    Text( provider.getInvontoryModel!.data![index].stockStatus == 1?
