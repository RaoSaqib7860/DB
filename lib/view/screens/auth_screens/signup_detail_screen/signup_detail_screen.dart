                              ...
                              TextSpan(
                                  ...
                                  recognizer: TapGestureRecognizer()
                                    ..onTap = () {
                                      Get.to(WebView(
                                        url:
                                            'https://www.dialboxx.pk/front/terms',
                                        appbar: false,
                                      ));
                                    },
                                  style: TextStyle(
                              ...
                              TextSpan(
                                  ...
                                  recognizer: TapGestureRecognizer()
                                    ..onTap = () {
                                      Get.to(WebView(
                                        url:
                                            'https://www.dialboxx.pk/front/privacy',
                                        appbar: false,
                                      ));
                                    },
                                  style: TextStyle(
                      ...
                      GestureDetector(
                        onTap: () {
                          if (provider.passwordController.text ==
                              ...
                              if (provider
                                ...
                                if (provider.domainController.text.isNotEmpty) {
                                  if (provider
                                    ...
                                    Get.snackbar('Alert'.tr,
                                        'Mobile number is empty.'.tr);
                                  }
                                } else {
                                  Get.snackbar(
                                      'Alert'.tr, 'Domain is empty.'.tr);
                                }
                              } else {
                                Get.snackbar(
                            ...
                            Get.snackbar(
                                'Alert'.tr, 'Password not matched.'.tr);
                          }
                        },
                        child: Container(
                          decoration: BoxDecoration(
